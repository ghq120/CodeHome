    		...
    		<td>
    			...
    			<table width="100%" height="90%" >
    				...
    				<tr>
		    			...
		    			<a href="<%=path %>/BookServlet?whichrequest=pagebook&curpage=1">首页</a>
		    			<a href="<%=path %>/BookServlet?whichrequest=pagebook&curpage=${curpage-1 }">上一页</a>
		    			<a href="<%=path %>/BookServlet?whichrequest=pagebook&curpage=${curpage+1 }">下一页</a>
		    			<a href="<%=path %>/BookServlet?whichrequest=pagebook&curpage=${totalpage }">尾页</a>&nbsp;&nbsp;
		    			<form action="<%=path %>/BookServlet?whichrequest=pagebook" method="post">
